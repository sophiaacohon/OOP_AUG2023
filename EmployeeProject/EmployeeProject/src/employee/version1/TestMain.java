...
/* Employee Project Version 1 - Main
...
public class TestMain {
    public static void main(String[] args) {
        //Testing Hourly Exmployee Output
        myDate he1BDate = new myDate(14, "Jul", 1985);
        myDate he1HDate = new myDate(1, "May", 2007);
        HourlyEmployee he1 = new HourlyEmployee(1, "Andre O.", he1BDate, he1HDate, 45, 450);
        myDate he2BDate = new myDate(27, "Aug", 1973);
        myDate he2HDate = new myDate(1, "Jun", 2023);
        HourlyEmployee he2 = new HourlyEmployee(2, "Romer F.", he2BDate, he2HDate, 40, 450);
        he1.displayInfo();
        System.out.println(he1);
        he2.displayInfo();
        System.out.println(he2);

        //Testing Piece Worker Employee Output
        ...
        PieceWorkerEmployee pwe2 = new PieceWorkerEmployee(4, "Sally C.", pwe2BDate, pwe2HDate, 200, 10);
        pwe1.displayInfo();
        System.out.println(pwe1);
        pwe2.displayInfo();
        System.out.println(pwe2);

        //Testing Commission Employee Output
        ...
        //Testing Base Plus Commission Employee Output

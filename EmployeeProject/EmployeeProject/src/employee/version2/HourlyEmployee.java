...
/* Employee Project Version 2 - Hourly Employee
 * Made by: Sophia Ann Cohon
 * Created on: September 15, 2023
 * Finished on: September 21, 2023
 * Program Description: Computes the salary of Hourly Employee and displays their information
*/
...
public class HourlyEmployee extends Employee{
    ...
    public HourlyEmployee(float totalHoursWorked, float ratePerHour, int empID, String empName, myDate empBirthDate, myDate empDateHired) {
